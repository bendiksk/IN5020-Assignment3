...
public class ReportWriter {
    private static String fileInDeg = "graphStats/inDegreeData-shuffle-star-30cache.txt";
    private static String fileCluster = "graphStats/clusteringCoefficientData-shuffle-star-30cache.txt";
    private static String fileShortestPath = "graphStats/shortestPathData-shuffle-star-30cache.txt";
